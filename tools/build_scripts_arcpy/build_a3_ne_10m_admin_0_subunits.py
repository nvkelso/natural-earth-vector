# ---------------------------------------------------------------------------
# build_a3_ne_10m_admin_0_subunits.py
# Created on: Sat Aug 19 2017 11:43:31 PM
...
# Local variables...
ne_10m_admin_0_map_subunits_shp = "C:\\ProjectFiles\\NaturalEarth\\nev_version_4d0d0\\10m_cultural\\ne_10m_admin_0_map_subunits.shp"
ne_10m_admin_0_map_subunits_shp__4_ = "C:\\ProjectFiles\\NaturalEarth\\nev_version_4d0d0\\10m_cultural\\ne_10m_admin_0_map_subunits.shp"
...
# Process: Dissolve...
gp.Dissolve_management(ne_10m_admin_0_scale_rank_shp, ne_10m_admin_0_map_subunits_shp, "sr_su_a3", "scalerank MIN", "MULTI_PART", "DISSOLVE_LINES")

# Process: Add Field (2)...
gp.AddField_management(ne_10m_admin_0_map_subunits_shp, "scalerank", "SHORT", "", "", "", "", "NON_NULLABLE", "NON_REQUIRED", "")
...
gp.DeleteField_management(ne_10m_admin_0_map_subunits_shp__4_, "sr_su_a3;MIN_scaler")
